document.addEventListener('DOMContentLoaded', () => {
    ...
    const navBusinessApp = document.getElementById('nav-business-app');
    ...
    const businessAppContent = document.getElementById('business-app-content');
    ...
    function hideAllContent() {
        ...
        if (businessAppContent) businessAppContent.style.display = 'none';
    }
    ...
    navBusinessApp?.addEventListener('click', (e) => {
        e.preventDefault();
        hideAllContent();
        if (businessAppContent) businessAppContent.style.display = 'block';
        updateActiveLink(navBusinessApp);
        initBusinessApp();
    });

    // --- Business App Logic ---
    let businessAppInitialized = false;
    function initBusinessApp() {
        if (businessAppInitialized) return;
        businessAppInitialized = true;
