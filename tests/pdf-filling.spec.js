...
test('should reset the form and PDF', async ({ page }) => {
  ...
  // Upload a document to ensure the preview is also reset
  ...
  // Accept the confirmation dialog for reset
  ...
  // Assert file input and preview are cleared
  await expect(page.locator('#document-upload')).toBeEmpty();
  await expect(preview).toBeHidden();

  // Wait for UI to update and take a screenshot
...
//     window.Tesseract = {
//       recognize: () =>
//         Promise.resolve({ data: { text: 'John Doe\\nAcme Inc.\\njohn.doe@acme.com\\n123-456-7890' } }),
//     };
//   });
